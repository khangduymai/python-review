...
if __name__ == '__main__':
    ...
    # with open('D:\python\Python_practice\documents\\test.html', 'w') as test_doc:
    #     my_page.display(file=test_doc)

    new_body = Body()
    new_body.add_tag('h1', 'Aggregation')
    new_body.add_tag('h1', "Unline <strong>composition</strong>, aggregation uses existing instances"
...
# give our document new content by switching its body
    ...
    with open('D:\python\Python_practice\documents\\test3.html', 'w') as test_doc:
        my_page.display(file=test_doc)
# %%
